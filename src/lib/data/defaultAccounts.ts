...
export const DEFAULT_ACCOUNTS: Omit<Account, 'id'>[] = [
  ...
  { code: '521', nameJa: '租税公課',       category: 'expense', defaultTaxRate: 0,    isAllocatable: false },
  { code: '522', nameJa: '荷造運賃',       category: 'expense', defaultTaxRate: 0.10, isAllocatable: false },
  { code: '523', nameJa: '水道光熱費',     category: 'expense', defaultTaxRate: 0.10, isAllocatable: true  },
  { code: '524', nameJa: '旅費交通費',     category: 'expense', defaultTaxRate: 0.10, isAllocatable: false },
  { code: '525', nameJa: '通信費',         category: 'expense', defaultTaxRate: 0.10, isAllocatable: true  },
  ...
  { code: '530', nameJa: '消耗品費',       category: 'expense', defaultTaxRate: 0.10, isAllocatable: false },
  ...
  { code: '541', nameJa: '会議費',         category: 'expense', defaultTaxRate: 0.10, isAllocatable: false },
  { code: '542', nameJa: '新聞図書費',     category: 'expense', defaultTaxRate: 0.10, isAllocatable: false },
  ...
  { code: '599', nameJa: '雑費',           category: 'expense', defaultTaxRate: 0.10, isAllocatable: false },
];